                                    ...
                                    <td>
                                        <Dropdown>
                                            ...
                                            <Dropdown.Menu>
                                                ...
                                                <Dropdown.Item ><Link className="menu-link" to={`${AppRoute.EMPLOYEE_CONTRACT.path.replace(':id', item.id)}`}><span><FontAwesomeIcon icon={faFileAlt}/> Hợp đồng lao động </span></Link></Dropdown.Item>
