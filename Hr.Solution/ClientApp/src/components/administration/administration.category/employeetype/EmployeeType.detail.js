                        ...
                        <div className="d-flex">
                            <div className="w-30 pl-4 pt-3 mr-5">
                                ...
                                <label className="w-100 mt-2 text-camelcase">
                                    Phân loại:
                                    {/* CALL_API get phân loại nhân viên */}
                                ...
                                <label className="w-100 mt-2 text-camelcase">
                                    % chế độ lương:
                                    <input fieldname="percentSalary" type="number" value={model.percentSalary} onChange={this.onInputChange} disabled={mode === Mode.VIEW} className="form-control" placeholder="% chế độ lương"></input>
                                </label>
                            ...
                            <label className="w-100">
                                ...
                                <label className="w-100 mt-2 text-camelcase">
                                    % lương mềm:
                                    <input fieldname="percentSoftSalary" value={model.percentSoftSalary} type="number" onChange={this.onInputChange} disabled={mode === Mode.VIEW} className="form-control" placeholder="% lương mềm"></input>
                                </label>
